  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 px-4 py-4 md:ml-64 pt-20">
      ...
      {!loading && filteredCustomers.length === 0 ? (
        ...
        <>
          {/* Desktop View */}
          <div className="hidden md:block w-full max-w-auto bg-white shadow-lg rounded-lg mx-auto">
            <div className="bg-[#B72765] grid grid-cols-4 font-semibold text-center text-sm px-6 py-4 text-white rounded-t-lg">
              <div>Client Name</div>
              <div>Email</div>
              <div>Linked Vet</div>
              <div>Date</div>
            ...
            <div className="max-h-auto overflow-y-auto divide-y">
              {filteredCustomers.map((item) => (
                <div
                  key={item.id}
                  className="grid grid-cols-4 px-6 py-4 text-center text-sm text-gray-700 hover:bg-gray-50 transition"
                >
