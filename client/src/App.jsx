...
import ShopifyGofrugalCustomers from './Components/shopifyGofrugalCustomer/ShopifyGofrugalCustomer'
      ...
      {isAuthenticated ? (
        <>
          ...
          <Routes>
            ...
            <Route path="/dashboard/customer-list" element={<ShopifyGofrugalCustomers />} />
